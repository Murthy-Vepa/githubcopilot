# Video Script 02 — AI-Assisted Development in Practice
...
*[TITLE CARD: "AI-Assisted Development in Practice" | Module 3 · AI-Assisted Development & Spec-Driven Dev]*
...
**JORDAN:** "AI-Assisted Development" gets a bad reputation because people conflate it with "lazy coding" or "copy-paste coding." That's not what it is.

**JORDAN:** AI-Assisted Development is *conversational AI-assisted development* — an iterative dialogue between you and Copilot where the code emerges from a back-and-forth exploration rather than a pre-specified plan.
...
**JORDAN:** Contrast that with spec-driven development, where you define everything upfront and then execute. AI-Assisted Development is non-linear. You discover as you go. Each Copilot response gives you new information that shapes your next question.
...
**JORDAN:** This is the most important trap to avoid. AI-Assisted Development is not a strategy for production systems. It's a strategy for exploration. When the exploration is done and you're building for keeps — spec first.
...
**JORDAN:** AI-Assisted Development is conversational AI-assisted development — iterative, exploratory, intuitive. Powerful for discovery, prototyping, and learning.
...
- **Runtime:** ~13 minutes
- **Chapter markers:** 0:00 Cold Open · 1:00 What AI-Assisted Development Is · 3:00 The Vibe Loop Demo · 5:30 Techniques · 7:15 Traps · 9:00 Full Demo · 10:45 Recap
